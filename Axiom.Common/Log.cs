...
namespace Axiom.Common
{
    public class Log
    {
        ...
        public static string EchoPath = System.Configuration.ConfigurationManager.AppSettings["LogPath"] + "\\log.txt";
        public static string ServiceLogPath = System.Configuration.ConfigurationManager.AppSettings["LogPath"] + "\\ServiceLog.txt";
        ...
        public static bool ServiceLogEnabled = true;
