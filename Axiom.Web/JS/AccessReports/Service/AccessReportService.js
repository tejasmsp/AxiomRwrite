app.service('AccessReportService', function ($http, configurationService) {
    ...
    accessReportService.DownloadAccessReportAgedARSummary = function (StartDate, EndDate, CompanyID, FirmID) {
        $http({
            // url: configurationService.basePath + "DownloadInvoice?strHTML=" + JSON.stringify(strHTML),
            url: configurationService.basePath + "DownloadAgedARSummary?StartDate=" + StartDate + "&EndDate=" + EndDate + "&CompanyID=" + CompanyID + "&FirmID=" + FirmID,
            method: "GET",
            // data: reportName,
            // data: "strHTML=" + strHTML,
            contentType: "application/json; charset=utf-8",
