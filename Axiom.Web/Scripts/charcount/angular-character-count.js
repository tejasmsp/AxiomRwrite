...
angular.module('angular-character-count', []).directive('charCount', ['$parse', '$compile', function ($parse, $compile) {
    return {
        ...
        link: function (scope, element, attr, ngModel) {
            ...
            $(element).after('<p style="margin: 0!important;padding-left:5px;" id=' + idP + '></p>');
                ...
                function (newValue) {
                    ...
                    if (angular.isDefined(newValue)) {
                        ...
                        var remainingChar = attr.ngMaxlength - newValue.length;
                         var remaiSpan = "<p style='margin:0 !important;'>" + remainingChar + " of " + attr.ngMaxlength + " characters left.</p>";
                        $('#' + idP).html(remaiSpan);
